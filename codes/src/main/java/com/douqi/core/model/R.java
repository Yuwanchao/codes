...
import com.douqi.core.exception.BusinessException;
...
public class R<T> {
    ...
    public static <T> R success(String message) {
        return new R(Constants.Response.SUCCESS.getCode(), message, null, null, null);
    }
    ...
    public static R failure(String message){
        return new R(Constants.Response.FAILURE.getCode(), message, null, null, null);
    }
